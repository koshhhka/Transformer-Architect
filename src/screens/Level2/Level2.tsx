  ...
  return(
    <div className={styles.messagegroup}>
      <div className={styles.messagetextaround}>
        ...
        Разместите блоки в правильном порядке, чтобы собрать энкодер.
        </div>
      </div>
    ...
    <div>
      ...
      <div className={styles.maincontainer}>
        <div className={styles.container1}>
          ...
          {blocks.filter((block) => !droppedBlocks.map(dropped => dropped.id).includes(block.id)).map((block) => (
        ...
        <div className={styles.container22}>
          ...
          <div className={styles.direction2}>
            ...
            <Link to="/level2" className={styles.toLevel3}>
              <span>Сбросить</span>
            </Link>
            </div>
